  ...
  return (
    <div className="flex flex-col h-full w-full p-4 md:p-8 animate-in fade-in zoom-in duration-300">
      ...
      <div className="mb-6">
        <button
          onClick={onBack}
          className={`inline-flex items-center justify-center p-2 rounded-full border transition-all duration-300 ease-in-out cursor-pointer ${theme === "dark"
      ...
      <div className="max-w-3xl w-full mx-auto space-y-6">
        ...
        <div className="opacity-50 text-sm text-center pt-10">
